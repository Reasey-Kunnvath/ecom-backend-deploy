    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Skill</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Skills</h1>
            </div>
            <div class="sm:flex">
                <div
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($skills as $index => $skill)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td
                                        class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $skill->created_at ? $skill->created_at->format('d M Y g:i A') : 'N/A' }}
                                    </td>
                                    <td
                                        class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $skill->updated_at ? $skill->updated_at->format('d M Y g:i A') : 'N/A' }}

                                    </td>

                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <!-- View -->
                                        <button type="button" wire:click="view_modal({{ $skill->id }})"
                                        ...
                                        <!-- Edit -->
                                        <button type="button" wire:click="edit_modal({{ $skill->id }})"
                                        ...
                                        <button type="button" data-modal-target="delete-industry-modal"
                                            ...
                                            wire:click="deleteConfirmed({{ $skill->id }})"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="mb-4">
                            <label for="skill_code"
                                class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Skill
                                Code</label>
                            <div class="col-span-6 sm:col-span-2">
                                <input id="skill_code" type="text" name="skill_code" wire:model="skill_code"
                        ...
                        <div class="mb-4">
                            <label for="skill_name"
                                ...
                                Name</label>
                            <div class="col-span-6 sm:col-span-2">
                                <input id="skill_name" type="text" name="skill_name" wire:model="skill_name"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="mb-4">
                            <label for="skill_category"
                                class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Skill
                                Category</label>
                            <select id="skill_category" name="skill_category" wire:model="skill_category"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                @foreach ($skillCategories as $skillCategory)
                                    <option value="{{ $skillCategory->id }}"
                                        {{ $skill_category == $skillCategory->id ? 'selected' : '' }}>
                                        {{ $skillCategory->industry_name }}</option>)
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            <label for="skill_desc"
                                class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Skill
                                Description</label>
                            <textarea id="skill_desc" name="skill_desc" wire:model="skill_desc"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Skill Description" rows="4"></textarea>
                        </div>
                    </div>
                    @if (!$isViewMode)
                        <div class="mt-6">
